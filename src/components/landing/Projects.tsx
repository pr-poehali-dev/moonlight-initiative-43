    ...
    <section id="advantages" className="my-20">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {advantages.map((item) => (
          <div
            key={item.id}
            className="bg-[#fffdfb] dark:bg-[#262019] rounded-3xl p-6 border-b-4 border-[#2EC4B6] shadow-sm hover:shadow-md transition-shadow duration-300"
          >
            ...
            <h3 className="text-base font-semibold mb-2 text-[#2b2620] dark:text-white">{item.title}</h3>
