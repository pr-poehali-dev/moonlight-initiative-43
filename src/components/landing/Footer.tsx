...
export default function Footer() {
  return (
    <footer className="container py-12 border-t border-[#dde4ef] dark:border-[#2a2d30]">
      <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-10">
        ...
        <div>
          <h4 className="font-semibold text-[#1a1f2e] dark:text-white mb-4">Контакты</h4>
      ...
      <div className="pt-6 border-t border-[#dde4ef] dark:border-[#2a2d30] flex flex-col md:flex-row items-center justify-between gap-4">
